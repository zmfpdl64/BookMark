...
### 수행 시간
2024.10.10 ~ 2024.11.03 1차 배포 완료
...
- Repository는 DB와 Java간의 연결을 담당합니다.
- Service는 각 도메인에대한 비즈니스를 담당합니다.
- Adaptor 클래스는 여러개의 서비스를 연결하는 클래스 계층입니다.
이 방식은 서비스끼리의 참조를 하는 참조 순환으로부터 안정적인 특징을 가지고 있으며, 각 서비스의 트랜잭션 관리도 담당하고 있습니다. 
